  ...
  projects: [
    {
      ...
      cover: "../dist/assets/dftrhrg.webp", // Contoh setelah file ada: "assets/projects/poster-kegiatan.webp"
      coverAlt: "Daftar harga dengan judul utama, harga, produk dan informasi pembayaran",
      previews: [{ type: "image", src: "../dist/assets/dftrhrg.webp", alt: "Poster lengkap" }], // Contoh: [{ type: "image", src: "assets/projects/poster-kegiatan.webp", alt: "Poster lengkap" }]
    ...
    },
    {
      ...
      cover: "../dist/assets/DUMP.webp",
      coverAlt: "Dump Laporan Akademik dengan teks dummy",
      previews: [ { type: "image", src: "../dist/assets/DUMP.webp", alt: "Halaman laporan dengan teks dummy" } ],
